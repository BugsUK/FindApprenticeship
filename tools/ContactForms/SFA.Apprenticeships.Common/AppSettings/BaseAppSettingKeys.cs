...
{
    public class BaseAppSettingKeys
    {
        public const string ReferenceDataPath = "ReferenceDataPathWithFile";
        ...
        public const string PostCodeAnywhereApiKey = "PostCodeAnywhereApiKey";
    }
}