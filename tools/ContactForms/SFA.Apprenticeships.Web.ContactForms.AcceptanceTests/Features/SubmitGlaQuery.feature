Feature: SubmitGlaQuery
	In order to finding out more about employing apprentices 
	As an employer 
	I want to able to send gla employer query form

@SmokeTests
Scenario: As a gla employer I am on the gla employer contact page 
	...
	Given I navigated to the GlaEmployerEnquiryPage page	
	When I am on the GlaEmployerEnquiryPage page
	...
	And I am on the GlaEmployerEnquiryPage page
	And I enter data
		| Field           | Value                  |
	...
	And I enter data
		| Field              | Value                                                                    |
		| EnquiryDescription | This is a UI test to verify validation & submission is working correctly |	
	Then I see 
		| Field                     | Rule   | Value |
		| ValidationFieldErrorCount | Equals | 0     |
	And I am on the GlaEmployerEnquiryPage page
	When I choose SendEmployerEnquiryButton	
	And I am on the ThankYouPageGlaEmployerEnquiry page
...
@SmokeTest
Scenario: As a gla employer I am on the gla employer contact page and all required fields are present and all validators show correct validation messages	
	Given I navigated to the GlaEmployerEnquiryPage page	
	When I am on the GlaEmployerEnquiryPage page	
	And I choose SendEmployerEnquiryButton
	And I wait to see ValidationSummary
