...
namespace SFA.Apprenticeships.Web.ContactForms.Tests.Mediators
{
    ...
    public class GlaEmployerEnquiryTests
    {
        ...
        public void SubmitGlaEnquiryTests(SubmitQueryStatus submitQueryStatus, string mediatorCode, string pageMessage, UserMessageLevel userMessageLevel)
        {
            //Arrange
            ...
            employerProviderMock.Setup(x => x.SubmitGlaEnquiry(It.IsAny<EmployerEnquiryViewModel>())).Returns(submitQueryStatus);
            ...
            //Act
            var response = mediator.SubmitGlaEnquiry(employerEnquiryViewModel);
        ...
        [Test]
        public void SubmitGlaEnquiryValidationTests()
        {
            //Arrange
