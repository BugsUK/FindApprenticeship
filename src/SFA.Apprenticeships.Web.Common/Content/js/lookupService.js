...
(function ($) {
    ...
    function populateAddress(address) {
        window.locationAddressesViewModel.addLocationAddressByField(address.Line1, address.Line2, address.Line3, address.Line4, address.Line5, address.City, address.PostalCode, null, address.DomesticId);
    }
