...
WriteAttribute("href", Tuple.Create(" href=\'", 1276), Tuple.Create("\'", 1327)
            
            #line 31 "..\..\Views\Login\Index.cshtml"
, Tuple.Create(Tuple.Create("", 1283), Tuple.Create<System.Object, System.Int32>(Url.Action(RouteNames.ForgottenCredentials)
...
WriteLiteral(@">
                            ...
                            <li>To activate your account sign in using your email address and password</li>
...
WriteLiteral("                ");
           ...
           Write(Html.ActionLink("create an account", "Index", "Register", null, new { id = "create-account-link" }));
            ...
            #line default
            #line hidden
WriteLiteral(" if you\'ve not used this service before.\r\n            </p>\r\n            <p");
