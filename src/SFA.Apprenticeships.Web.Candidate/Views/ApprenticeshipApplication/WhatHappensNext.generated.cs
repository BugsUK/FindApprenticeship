...
WriteAttribute("href", Tuple.Create(" href=\'", 1937), Tuple.Create("\'", 1999)
            
            #line 36 "..\..\Views\ApprenticeshipApplication\WhatHappensNext.cshtml"
, Tuple.Create(Tuple.Create("", 1944), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.ApprenticeshipSearch)
...
WriteAttribute("id", Tuple.Create(" id=\"", 2573), Tuple.Create("\"", 2634)
, Tuple.Create(Tuple.Create("", 2578), Tuple.Create("suggested-vacancy-", 2578), true)
            
            #line 48 "..\..\Views\ApprenticeshipApplication\WhatHappensNext.cshtml"
, Tuple.Create(Tuple.Create("", 2596), Tuple.Create<System.Object, System.Int32>(Model.SuggestedVacancies[i].VacancyId
...
WriteAttribute("href", Tuple.Create(" href=\"", 2742), Tuple.Create("\"", 2868)
            
            #line 50 "..\..\Views\ApprenticeshipApplication\WhatHappensNext.cshtml"
, Tuple.Create(Tuple.Create("", 2749), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.ApprenticeshipDetails, new { id = Model.SuggestedVacancies[i].VacancyId.ToString() })
...
WriteAttribute("href", Tuple.Create(" href=\"", 3211), Tuple.Create("\"", 3344)
            
            #line 57 "..\..\Views\ApprenticeshipApplication\WhatHappensNext.cshtml"
, Tuple.Create(Tuple.Create("", 3218), Tuple.Create<System.Object, System.Int32>(Url.ApprenticeshipSearchViewModelRouteUrl(CandidateRouteNames.ApprenticeshipResults, Model.SuggestedVacanciesSearchViewModel)
...
WriteAttribute("title", Tuple.Create(" title=\"", 3345), Tuple.Create("\"", 3421)
, Tuple.Create(Tuple.Create("", 3353), Tuple.Create("View", 3353), true)
, Tuple.Create(Tuple.Create(" ", 3357), Tuple.Create("apprenticeships", 3358), true)
, Tuple.Create(Tuple.Create(" ", 3373), Tuple.Create("in", 3374), true)
, Tuple.Create(Tuple.Create(" ", 3376), Tuple.Create("category", 3377), true)
...
WriteAttribute("href", Tuple.Create(" href=\"", 3618), Tuple.Create("\"", 3649)
            
            #line 64 "..\..\Views\ApprenticeshipApplication\WhatHappensNext.cshtml"
, Tuple.Create(Tuple.Create("", 3625), Tuple.Create<System.Object, System.Int32>(ViewBag.SearchReturnUrl
...
WriteAttribute("href", Tuple.Create(" href=\"", 3832), Tuple.Create("\"", 3913)
            
            #line 71 "..\..\Views\ApprenticeshipApplication\WhatHappensNext.cshtml"
, Tuple.Create(Tuple.Create("", 3839), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(RouteNames.SignOut, new { returnUrl = ViewBag.FeedbackUrl })
