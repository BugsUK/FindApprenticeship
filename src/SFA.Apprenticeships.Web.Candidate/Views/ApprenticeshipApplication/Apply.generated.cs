...
WriteAttribute("href", Tuple.Create(" href=\"", 1624), Tuple.Create("\"", 1717)
            
            #line 36 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
, Tuple.Create(Tuple.Create("", 1631), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.ApprenticeshipDetails, new { id = Model.VacancyId })
...
WriteAttribute("onclick", Tuple.Create(" onclick=\'", 2910), Tuple.Create("\'", 3095)
, Tuple.Create(Tuple.Create("", 2920), Tuple.Create("Webtrends.multiTrack({", 2920), true)
, Tuple.Create(Tuple.Create(" ", 2942), Tuple.Create("element:", 2943), true)
, Tuple.Create(Tuple.Create(" ", 2951), Tuple.Create("this,", 2952), true)
, Tuple.Create(Tuple.Create(" ", 2957), Tuple.Create("argsa:", 2958), true)
, Tuple.Create(Tuple.Create(" ", 2964), Tuple.Create("[\"DCS.dcsuri\",", 2965), true)
, Tuple.Create(Tuple.Create(" ", 2979), Tuple.Create("\"/apprenticeship/apply/savedraft/", 2980), true)
            
            #line 65 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
                                                                                                                                                                       , Tuple.Create(Tuple.Create("", 3013), Tuple.Create<System.Object, System.Int32>(Model.VacancyId
            
            #line default
            #line hidden
, 3013), false)
, Tuple.Create(Tuple.Create("", 3029), Tuple.Create("\",", 3029), true)
, Tuple.Create(Tuple.Create(" ", 3031), Tuple.Create("\"WT.dl\",", 3032), true)
, Tuple.Create(Tuple.Create(" ", 3040), Tuple.Create("\"99\",", 3041), true)
, Tuple.Create(Tuple.Create(" ", 3046), Tuple.Create("\"WT.ti\",", 3047), true)
, Tuple.Create(Tuple.Create(" ", 3055), Tuple.Create("\"Apprenticeship", 3056), true)
, Tuple.Create(Tuple.Create(" ", 3071), Tuple.Create("–", 3072), true)
, Tuple.Create(Tuple.Create(" ", 3073), Tuple.Create("Save", 3074), true)
, Tuple.Create(Tuple.Create(" ", 3078), Tuple.Create("Draft", 3079), true)
, Tuple.Create(Tuple.Create(" ", 3084), Tuple.Create("Form\"]", 3085), true)
