...
WriteAttribute("href", Tuple.Create(" href=\"", 2886), Tuple.Create("\"", 2979)
            
            #line 57 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
, Tuple.Create(Tuple.Create("", 2893), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.ApprenticeshipDetails, new { id = Model.VacancyId })
...
WriteAttribute("onclick", Tuple.Create(" onclick=\'", 5269), Tuple.Create("\'", 5454)
, Tuple.Create(Tuple.Create("", 5279), Tuple.Create("Webtrends.multiTrack({", 5279), true)
, Tuple.Create(Tuple.Create(" ", 5301), Tuple.Create("element:", 5302), true)
, Tuple.Create(Tuple.Create(" ", 5310), Tuple.Create("this,", 5311), true)
, Tuple.Create(Tuple.Create(" ", 5316), Tuple.Create("argsa:", 5317), true)
, Tuple.Create(Tuple.Create(" ", 5323), Tuple.Create("[\"DCS.dcsuri\",", 5324), true)
, Tuple.Create(Tuple.Create(" ", 5338), Tuple.Create("\"/apprenticeship/apply/savedraft/", 5339), true)
            
            #line 99 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
                                                                                                                                                                  , Tuple.Create(Tuple.Create("", 5372), Tuple.Create<System.Object, System.Int32>(Model.VacancyId
            
            #line default
            #line hidden
, 5372), false)
, Tuple.Create(Tuple.Create("", 5388), Tuple.Create("\",", 5388), true)
, Tuple.Create(Tuple.Create(" ", 5390), Tuple.Create("\"WT.dl\",", 5391), true)
, Tuple.Create(Tuple.Create(" ", 5399), Tuple.Create("\"99\",", 5400), true)
, Tuple.Create(Tuple.Create(" ", 5405), Tuple.Create("\"WT.ti\",", 5406), true)
, Tuple.Create(Tuple.Create(" ", 5414), Tuple.Create("\"Apprenticeship", 5415), true)
, Tuple.Create(Tuple.Create(" ", 5430), Tuple.Create("–", 5431), true)
, Tuple.Create(Tuple.Create(" ", 5432), Tuple.Create("Save", 5433), true)
, Tuple.Create(Tuple.Create(" ", 5437), Tuple.Create("Draft", 5438), true)
, Tuple.Create(Tuple.Create(" ", 5443), Tuple.Create("Form\"]", 5444), true)
, Tuple.Create(Tuple.Create(" ", 5450), Tuple.Create("});", 5451), true)
);
...
WriteAttribute("href", Tuple.Create(" href=\"", 5671), Tuple.Create("\"", 5727)
            
            #line 103 "..\..\Views\ApprenticeshipApplication\Apply.cshtml"
                                                            , Tuple.Create(Tuple.Create("", 5678), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.MyApplications)
