...
"        if (results == null)\r\n                return null;\r\n            else\r\n  " +
"              return results[1];\r\n        }\r\n\r\n        if (gup(\'FromSubmitted\') " +
"== \"true\") {\r\n            var categoryType = gup(\'Category\').toLowerCase(),\r\n   " +
"             subCatType = gup(\'SubCategories\'),\r\n                $scrollingPanel" +
" = $(\'#sub-category-\'+ categoryType +\'-list\'),\r\n                $subCatLi = $(\'#" +
"sub-category-\' + subCatType).parent();\r\n\r\n            $scrollingPanel.scrollTop(" +
"$subCatLi.position().top);\r\n\r\n        }\r\n\r\n        function GetSearchResultsDeta" +
"ilsValue(searchResultDetail) {\r\n            //Get URL param first\r\n            v" +
"ar queryParams = $.getQueryParameters();\r\n            var queryValue = queryPara" +
"ms[searchResultDetail];\r\n            if (typeof queryValue !== \'undefined\' && qu" +
"eryValue != null) {\r\n                return queryValue.toLowerCase() === \'true\';" +
"\r\n            }\r\n\r\n            //If that fails use cookie value\r\n            var" +
" cookieValues = $.getCookieValues(\'NAS.SearchResultsDetails\');\r\n            var " +
"cookieValue = cookieValues[searchResultDetail];\r\n            if (typeof cookieVa" +
"lue !== \'undefined\' && cookieValue != null) {\r\n                return cookieValu" +
"e.toLowerCase() === \'true\';\r\n            }\r\n\r\n            //Otherwise use defaul" +
"ts\r\n            return null;\r\n        }\r\n\r\n        function GetSearchResultsDeta" +
"ilsValues() {\r\n            //Assemble query string or cookie compatible value fr" +
"om inputs\r\n            var detailsValue = $(\'#chooseDetails input\').toArray().ma" +
"p(function (value) {\r\n                return $(value).attr(\'id\') + \"=\" + $(value" +
").is(\':checked\');\r\n            }).join(\"&\");\r\n\r\n            return detailsValue;" +
"\r\n        }\r\n\r\n        function SetSearchResultsDetailsCookieValue() {\r\n        " +
"    //Assemble cookie value from inputs\r\n            var cookieValue = GetSearch" +
"ResultsDetailsValues();\r\n\r\n            //Break early if the cookie was empty. Th" +
"is happens if there are no results.\r\n            //Saving and empty cookie would" +
" reset the user\'s settings\r\n            if (!cookieValue)\r\n                retur" +
"n;\r\n\r\n            //Need the cookie not to be encoded so it\'s compatible with MV" +
"C\r\n            $.cookie.raw = true;\r\n\r\n            //Write the new, complete coo" +
"kie with the current view of the display settings\r\n            $.cookie(\'NAS.Sea" +
"rchResultsDetails\', cookieValue);\r\n        }\r\n    </script>\r\n\r\n");

WriteLiteral("    ");

            
            #line 320 "..\..\Views\ApprenticeshipSearch\Results.cshtml"
