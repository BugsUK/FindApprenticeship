...
WriteAttribute("class", Tuple.Create(" class=\"", 4763), Tuple.Create("\"", 4867)
, Tuple.Create(Tuple.Create("", 4771), Tuple.Create("inline", 4771), true)
, Tuple.Create(Tuple.Create(" ", 4777), Tuple.Create("tabbed-element", 4778), true)
, Tuple.Create(Tuple.Create(" ", 4792), Tuple.Create("searchtab", 4793), true)
            
            #line 70 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 4802), Tuple.Create<System.Object, System.Int32>(keywordTabControlClass
...
, 4803), false)
            ...
            #line 70 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
       , Tuple.Create(Tuple.Create(" ", 4826), Tuple.Create<System.Object, System.Int32>(categoriesTabClass
...
, 4827), false)
            ...
            #line 70 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
                           , Tuple.Create(Tuple.Create(" ", 4846), Tuple.Create<System.Object, System.Int32>(elementControlClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 5681), Tuple.Create("\"", 5744)
, Tuple.Create(Tuple.Create("", 5689), Tuple.Create("button", 5689), true)
, Tuple.Create(Tuple.Create(" ", 5695), Tuple.Create("tabbed-element", 5696), true)
, Tuple.Create(Tuple.Create(" ", 5710), Tuple.Create("searchtab", 5711), true)
            
            #line 82 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 5720), Tuple.Create<System.Object, System.Int32>(keywordTabControlClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 5813), Tuple.Create("\"", 5893)
, Tuple.Create(Tuple.Create("", 5821), Tuple.Create("button", 5821), true)
, Tuple.Create(Tuple.Create(" ", 5827), Tuple.Create("tabbed-element", 5828), true)
            
            #line 83 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 5842), Tuple.Create<System.Object, System.Int32>(categoriesTabClass
...
, 5843), false)
            ...
            #line 83 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 5862), Tuple.Create<System.Object, System.Int32>(categoriesElementControlClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 6067), Tuple.Create("\"", 6153)
, Tuple.Create(Tuple.Create("", 6075), Tuple.Create("button", 6075), true)
, Tuple.Create(Tuple.Create(" ", 6081), Tuple.Create("tabbed-element", 6082), true)
            
            #line 87 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 6096), Tuple.Create<System.Object, System.Int32>(savedSearchesTabClass
...
, 6097), false)
            ...
            #line 87 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
       , Tuple.Create(Tuple.Create(" ", 6119), Tuple.Create<System.Object, System.Int32>(savedSearchesElementControlClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 6355), Tuple.Create("\"", 6434)
, Tuple.Create(Tuple.Create("", 6363), Tuple.Create("tabbed-element", 6363), true)
            
            #line 93 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 6377), Tuple.Create<System.Object, System.Int32>(savedSearchesTabClass
...
, 6378), false)
            ...
            #line 93 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 6400), Tuple.Create<System.Object, System.Int32>(savedSearchesElementControlClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 6779), Tuple.Create("\"", 6904)
, Tuple.Create(Tuple.Create("", 6787), Tuple.Create("tabbed-element", 6787), true)
, Tuple.Create(Tuple.Create(" ", 6801), Tuple.Create("disp-block", 6802), true)
, Tuple.Create(Tuple.Create(" ", 6812), Tuple.Create("form-group", 6813), true)
, Tuple.Create(Tuple.Create(" ", 6823), Tuple.Create("searchtab", 6824), true)
            
            #line 100 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create(" ", 6833), Tuple.Create<System.Object, System.Int32>(keywordTabControlClass
...
, 6834), false)
            ...
            #line 100 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
                      , Tuple.Create(Tuple.Create(" ", 6857), Tuple.Create<System.Object, System.Int32>(categoriesTabClass
...
, 6858), false)
            ...
            #line 100 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
                                          , Tuple.Create(Tuple.Create(" ", 6877), Tuple.Create<System.Object, System.Int32>(categoriesTabControlClass
...
WriteAttribute("value", Tuple.Create(" value=\"", 7471), Tuple.Create("\"", 7501)
            
            #line 107 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create("", 7479), Tuple.Create<System.Object, System.Int32>(Model.LatLonLocHash()
...
WriteAttribute("href", Tuple.Create(" href=\'", 8354), Tuple.Create("\'", 8404)
            
            #line 124 "..\..\Views\ApprenticeshipSearch\Index.cshtml"
, Tuple.Create(Tuple.Create("", 8361), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.Helpdesk)
