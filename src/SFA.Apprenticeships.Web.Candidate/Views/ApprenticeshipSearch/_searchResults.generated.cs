...
WriteLiteral(">Alternatively, try using the <a");

WriteAttribute("href", Tuple.Create(" href=\"", 1815), Tuple.Create("\"", 1887)
            
            #line 43 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
      , Tuple.Create(Tuple.Create("", 1822), Tuple.Create<System.Object, System.Int32>(Url.RouteUrl(CandidateRouteNames.ApprenticeshipSearch)
            
            #line default
            #line hidden
, 1822), false)
, Tuple.Create(Tuple.Create("", 1877), Tuple.Create("#browsetab", 1877), true)
);

WriteLiteral(">category search</a> to browse for an apprenticeship.</p>\r\n");
...
WriteAttribute("class", Tuple.Create(" class=\"", 7499), Tuple.Create("\"", 7611)
, Tuple.Create(Tuple.Create("", 7507), Tuple.Create("font-small", 7507), true)
, Tuple.Create(Tuple.Create(" ", 7517), Tuple.Create("hidden-subcategory", 7518), true)
            
            #line 122 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                          , Tuple.Create(Tuple.Create(" ", 7536), Tuple.Create<System.Object, System.Int32>(Model.VacancySearch.DisplaySubCategory ? "inl-block" : "toggle-content"
...
WriteAttribute("id", Tuple.Create(" id=\"", 7732), Tuple.Create("\"", 7768)
, Tuple.Create(Tuple.Create("", 7737), Tuple.Create("number-of-positions-", 7737), true)
            
            #line 124 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 7757), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 8324), Tuple.Create("\"", 8352)
, Tuple.Create(Tuple.Create("", 8329), Tuple.Create("posted-date-", 8329), true)
            
            #line 135 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 8341), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 8951), Tuple.Create("\"", 8985)
, Tuple.Create(Tuple.Create("", 8956), Tuple.Create("save-vacancy-link-", 8956), true)
            
            #line 144 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 8974), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 9365), Tuple.Create("\"", 9395)
, Tuple.Create(Tuple.Create("", 9370), Tuple.Create("applied-label-", 9370), true)
            
            #line 146 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 9384), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 9837), Tuple.Create("\"", 9873)
, Tuple.Create(Tuple.Create("", 9842), Tuple.Create("number-of-positions-", 9842), true)
            
            #line 153 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 9862), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("class", Tuple.Create(" class=\"", 10091), Tuple.Create("\"", 10194)
            
            #line 157 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 10099), Tuple.Create<System.Object, System.Int32>(vacancy.VacancyLocationType == ApprenticeshipLocationType.NonNational ? "grid grid-2-3" : ""
...
WriteAttribute("id", Tuple.Create(" id=\"", 12859), Tuple.Create("\"", 12899)
, Tuple.Create(Tuple.Create("", 12864), Tuple.Create("positive-about-disabled-", 12864), true)
            
            #line 184 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 12888), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("src", Tuple.Create(" src=\"", 13022), Tuple.Create("\"", 13095)
            
            #line 185 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 13028), Tuple.Create<System.Object, System.Int32>(Url.CdnContent("img/logo-ticks-small-2x.png", "~/Content/_assets")
...
WriteAttribute("href", Tuple.Create(" href=\"", 14199), Tuple.Create("\"", 14309)
, Tuple.Create(Tuple.Create("", 14206), Tuple.Create("https://www.google.com/maps/dir/LocationLatLon/\'", 14206), true)
            
            #line 202 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 14254), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Latitude
...
, Tuple.Create(Tuple.Create("", 14280), Tuple.Create(",", 14280), true)
            ...
            #line 202 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                                   , Tuple.Create(Tuple.Create("", 14281), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Longitude
