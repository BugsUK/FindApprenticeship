...
WriteLiteral(">More/less detail</summary>\r\n                        <div");
...
WriteAttribute("class", Tuple.Create(" class=\"", 5521), Tuple.Create("\"", 5624)
, Tuple.Create(Tuple.Create("", 5529), Tuple.Create("font-small", 5529), true)
, Tuple.Create(Tuple.Create(" ", 5539), Tuple.Create("hidden-subcategory", 5540), true)
            
            #line 80 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                      , Tuple.Create(Tuple.Create(" ", 5558), Tuple.Create<System.Object, System.Int32>(Model.VacancySearch.DisplaySubCategory ? "" : "toggle-content"
...
WriteAttribute("id", Tuple.Create(" id=\"", 5760), Tuple.Create("\"", 5788)
, Tuple.Create(Tuple.Create("", 5765), Tuple.Create("posted-date-", 5765), true)
            
            #line 83 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 5777), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 6355), Tuple.Create("\"", 6389)
, Tuple.Create(Tuple.Create("", 6360), Tuple.Create("save-vacancy-link-", 6360), true)
            
            #line 92 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 6378), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 6761), Tuple.Create("\"", 6791)
, Tuple.Create(Tuple.Create("", 6766), Tuple.Create("applied-label-", 6766), true)
            
            #line 94 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 6780), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("class", Tuple.Create(" class=\"", 7143), Tuple.Create("\"", 7246)
            
            #line 99 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 7151), Tuple.Create<System.Object, System.Int32>(vacancy.VacancyLocationType == ApprenticeshipLocationType.NonNational ? "grid grid-2-3" : ""
...
WriteAttribute("href", Tuple.Create(" href=\"", 10387), Tuple.Create("\"", 10497)
, Tuple.Create(Tuple.Create("", 10394), Tuple.Create("https://www.google.com/maps/dir/LocationLatLon/\'", 10394), true)
            
            #line 135 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
    , Tuple.Create(Tuple.Create("", 10442), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Latitude
            
            #line default
            #line hidden
, 10442), false)
, Tuple.Create(Tuple.Create("", 10468), Tuple.Create(",", 10468), true)
            
            #line 135 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                               , Tuple.Create(Tuple.Create("", 10469), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Longitude
