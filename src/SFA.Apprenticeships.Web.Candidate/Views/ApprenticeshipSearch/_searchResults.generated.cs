...
WriteAttribute("id", Tuple.Create(" id=\"", 8249), Tuple.Create("\"", 8285)
, Tuple.Create(Tuple.Create("", 8254), Tuple.Create("number-of-positions-", 8254), true)
            
            #line 132 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 8274), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 9661), Tuple.Create("\"", 9695)
, Tuple.Create(Tuple.Create("", 9666), Tuple.Create("save-vacancy-link-", 9666), true)
            
            #line 158 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 9684), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 10075), Tuple.Create("\"", 10105)
, Tuple.Create(Tuple.Create("", 10080), Tuple.Create("applied-label-", 10080), true)
            
            #line 160 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 10094), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("class", Tuple.Create(" class=\"", 10530), Tuple.Create("\"", 10633)
            
            #line 167 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 10538), Tuple.Create<System.Object, System.Int32>(vacancy.VacancyLocationType == ApprenticeshipLocationType.NonNational ? "grid grid-2-3" : ""
...
WriteAttribute("id", Tuple.Create(" id=\"", 13396), Tuple.Create("\"", 13436)
, Tuple.Create(Tuple.Create("", 13401), Tuple.Create("positive-about-disabled-", 13401), true)
            
            #line 194 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 13425), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("src", Tuple.Create(" src=\"", 13559), Tuple.Create("\"", 13632)
            
            #line 195 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 13565), Tuple.Create<System.Object, System.Int32>(Url.CdnContent("img/logo-ticks-small-2x.png", "~/Content/_assets")
...
WriteAttribute("href", Tuple.Create(" href=\"", 14746), Tuple.Create("\"", 14856)
, Tuple.Create(Tuple.Create("", 14753), Tuple.Create("https://www.google.com/maps/dir/LocationLatLon/\'", 14753), true)
            
            #line 212 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 14801), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Latitude
            
            #line default
            #line hidden
, 14801), false)
, Tuple.Create(Tuple.Create("", 14827), Tuple.Create(",", 14827), true)
            
            #line 212 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                                   , Tuple.Create(Tuple.Create("", 14828), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Longitude
