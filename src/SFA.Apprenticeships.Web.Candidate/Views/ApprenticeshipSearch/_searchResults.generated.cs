...
WriteAttribute("class", Tuple.Create(" class=\"", 9818), Tuple.Create("\"", 9921)
            
            #line 153 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 9826), Tuple.Create<System.Object, System.Int32>(vacancy.VacancyLocationType == ApprenticeshipLocationType.NonNational ? "grid grid-2-3" : ""
...
WriteAttribute("id", Tuple.Create(" id=\"", 12586), Tuple.Create("\"", 12626)
, Tuple.Create(Tuple.Create("", 12591), Tuple.Create("positive-about-disabled-", 12591), true)
            
            #line 180 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 12615), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("src", Tuple.Create(" src=\"", 12749), Tuple.Create("\"", 12822)
            
            #line 181 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 12755), Tuple.Create<System.Object, System.Int32>(Url.CdnContent("img/logo-ticks-small-2x.png", "~/Content/_assets")
...
WriteAttribute("href", Tuple.Create(" href=\"", 13926), Tuple.Create("\"", 14036)
, Tuple.Create(Tuple.Create("", 13933), Tuple.Create("https://www.google.com/maps/dir/LocationLatLon/\'", 13933), true)
            
            #line 198 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 13981), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Latitude
            
            #line default
            #line hidden
, 13981), false)
, Tuple.Create(Tuple.Create("", 14007), Tuple.Create(",", 14007), true)
            
            #line 198 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                                   , Tuple.Create(Tuple.Create("", 14008), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Longitude
            
            #line default
            #line hidden
, 14008), false)
, Tuple.Create(Tuple.Create("", 14035), Tuple.Create("\'", 14035), true)
);
