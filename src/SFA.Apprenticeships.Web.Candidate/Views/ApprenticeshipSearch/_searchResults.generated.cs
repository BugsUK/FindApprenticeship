...
WriteAttribute("class", Tuple.Create(" class=\"", 7489), Tuple.Create("\"", 7601)
, Tuple.Create(Tuple.Create("", 7497), Tuple.Create("font-small", 7497), true)
, Tuple.Create(Tuple.Create(" ", 7507), Tuple.Create("hidden-subcategory", 7508), true)
            
            #line 122 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                          , Tuple.Create(Tuple.Create(" ", 7526), Tuple.Create<System.Object, System.Int32>(Model.VacancySearch.DisplaySubCategory ? "inl-block" : "toggle-content"
...
WriteAttribute("id", Tuple.Create(" id=\"", 7749), Tuple.Create("\"", 7777)
, Tuple.Create(Tuple.Create("", 7754), Tuple.Create("posted-date-", 7754), true)
            
            #line 125 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 7766), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 8376), Tuple.Create("\"", 8410)
, Tuple.Create(Tuple.Create("", 8381), Tuple.Create("save-vacancy-link-", 8381), true)
            
            #line 134 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 8399), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 8790), Tuple.Create("\"", 8820)
, Tuple.Create(Tuple.Create("", 8795), Tuple.Create("applied-label-", 8795), true)
            
            #line 136 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 8809), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("id", Tuple.Create(" id=\"", 9262), Tuple.Create("\"", 9298)
, Tuple.Create(Tuple.Create("", 9267), Tuple.Create("number-of-positions-", 9267), true)
            
            #line 143 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 9287), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("class", Tuple.Create(" class=\"", 9516), Tuple.Create("\"", 9619)
            
            #line 147 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 9524), Tuple.Create<System.Object, System.Int32>(vacancy.VacancyLocationType == ApprenticeshipLocationType.NonNational ? "grid grid-2-3" : ""
...
WriteAttribute("id", Tuple.Create(" id=\"", 12284), Tuple.Create("\"", 12324)
, Tuple.Create(Tuple.Create("", 12289), Tuple.Create("positive-about-disabled-", 12289), true)
            
            #line 174 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 12313), Tuple.Create<System.Object, System.Int32>(vacancy.Id
...
WriteAttribute("src", Tuple.Create(" src=\"", 12447), Tuple.Create("\"", 12520)
            
            #line 175 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
, Tuple.Create(Tuple.Create("", 12453), Tuple.Create<System.Object, System.Int32>(Url.CdnContent("img/logo-ticks-small-2x.png", "~/Content/_assets")
...
WriteAttribute("href", Tuple.Create(" href=\"", 13624), Tuple.Create("\"", 13734)
, Tuple.Create(Tuple.Create("", 13631), Tuple.Create("https://www.google.com/maps/dir/LocationLatLon/\'", 13631), true)
            
            #line 192 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
        , Tuple.Create(Tuple.Create("", 13679), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Latitude
...
, Tuple.Create(Tuple.Create("", 13705), Tuple.Create(",", 13705), true)
            ...
            #line 192 "..\..\Views\ApprenticeshipSearch\_searchResults.cshtml"
                                   , Tuple.Create(Tuple.Create("", 13706), Tuple.Create<System.Object, System.Int32>(vacancy.Location.Longitude
            
            #line default
            #line hidden
, 13706), false)
, Tuple.Create(Tuple.Create("", 13733), Tuple.Create("\'", 13733), true)
);
