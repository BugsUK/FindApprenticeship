...
WriteAttribute("class", Tuple.Create(" class=\"", 3708), Tuple.Create("\"", 3778)
            
            #line 80 "..\..\Views\TraineeshipSearch\Details.cshtml"
, Tuple.Create(Tuple.Create("", 3716), Tuple.Create<System.Object, System.Int32>(Model.IsWellFormedEmployerWebsiteUrl ? "no-btm-margin" : ""
...
WriteAttribute("href", Tuple.Create(" href=\"", 3948), Tuple.Create("\"", 3977)
            
            #line 83 "..\..\Views\TraineeshipSearch\Details.cshtml"
, Tuple.Create(Tuple.Create("", 3955), Tuple.Create<System.Object, System.Int32>(Model.EmployerWebsite
...
WriteAttribute("title", Tuple.Create(" title=\"", 4024), Tuple.Create("\"", 4059)
            
            #line 83 "..\..\Views\TraineeshipSearch\Details.cshtml"
                                                    , Tuple.Create(Tuple.Create("", 4032), Tuple.Create<System.Object, System.Int32>(Model.EmployerName
            
            #line default
            #line hidden
, 4032), false)
, Tuple.Create(Tuple.Create(" ", 4051), Tuple.Create("Website", 4052), true)
);
...
WriteAttribute("src", Tuple.Create(" src=\"", 5495), Tuple.Create("\"", 5650)
, Tuple.Create(Tuple.Create("", 5501), Tuple.Create("https://www.google.com/maps/embed/v1/place?q=", 5501), true)
            
            #line 104 "..\..\Views\TraineeshipSearch\Details.cshtml"
                                                            , Tuple.Create(Tuple.Create("", 5546), Tuple.Create<System.Object, System.Int32>(Html.Raw(Model.VacancyAddress.Postcode)
            
            #line default
            #line hidden
, 5546), false)
, Tuple.Create(Tuple.Create("", 5586), Tuple.Create(",+United+Kingdom&amp;key=AIzaSyCusA_0x4bJEjU-_gLOFiXMSBXKZYtvHz8", 5586), true)
);
