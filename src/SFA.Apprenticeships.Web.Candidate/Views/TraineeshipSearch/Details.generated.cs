...
, Tuple.Create(Tuple.Create("", 3309), Tuple.Create<System.Object, System.Int32>(Model.IsWellFormedEmployerWebsiteUrl ? "no-btm-margin" : ""
...
WriteAttribute("href", Tuple.Create(" href=\"", 3541), Tuple.Create("\"", 3570)
            
            #line 74 "..\..\Views\TraineeshipSearch\Details.cshtml"
, Tuple.Create(Tuple.Create("", 3548), Tuple.Create<System.Object, System.Int32>(Model.EmployerWebsite
...
WriteAttribute("title", Tuple.Create(" title=\"", 3617), Tuple.Create("\"", 3652)
            
            #line 74 "..\..\Views\TraineeshipSearch\Details.cshtml"
                                                    , Tuple.Create(Tuple.Create("", 3625), Tuple.Create<System.Object, System.Int32>(Model.EmployerName
            
            #line default
            #line hidden
, 3625), false)
, Tuple.Create(Tuple.Create(" ", 3644), Tuple.Create("Website", 3645), true)
);
...
WriteAttribute("src", Tuple.Create(" src=\"", 5077), Tuple.Create("\"", 5232)
, Tuple.Create(Tuple.Create("", 5083), Tuple.Create("https://www.google.com/maps/embed/v1/place?q=", 5083), true)
            
            #line 95 "..\..\Views\TraineeshipSearch\Details.cshtml"
                                                            , Tuple.Create(Tuple.Create("", 5128), Tuple.Create<System.Object, System.Int32>(Html.Raw(Model.VacancyAddress.Postcode)
            
            #line default
            #line hidden
, 5128), false)
, Tuple.Create(Tuple.Create("", 5168), Tuple.Create(",+United+Kingdom&amp;key=AIzaSyCusA_0x4bJEjU-_gLOFiXMSBXKZYtvHz8", 5168), true)
);
