 ...
 using (Html.BeginRouteForm(RouteNames.VerifyUpdatedEmail, FormMethod.Post))
{
            ...
            #line 23 "..\..\Views\Account\VerifyUpdatedEmailAddress.cshtml"
...
Write(Html.FormTextFor(m => m.PendingUsernameCode, controlHtmlAttributes: new { @class = "form-group-withlink", spellcheck = "false", autofocus = "autofocus", autocomplete = "off" }, labelText: "Enter code"));
...
WriteAttribute("href", Tuple.Create(" href=\"", 1156), Tuple.Create("\"", 1206)
            
            #line 30 "..\..\Views\Account\VerifyUpdatedEmailAddress.cshtml"
, Tuple.Create(Tuple.Create("", 1163), Tuple.Create<System.Object, System.Int32>(Url.Action("ResendUpdateEmailAddressCode")
