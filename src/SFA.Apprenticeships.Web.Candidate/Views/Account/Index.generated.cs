...
WriteAttribute("href", Tuple.Create(" href=\"", 13791), Tuple.Create("\"", 13867)
            
            #line 235 "..\..\Views\Account\Index.cshtml"
                                                    , Tuple.Create(Tuple.Create("", 13798), Tuple.Create<System.Object, System.Int32>(Url.Action("Archive", "Account", new { id = application.VacancyId })
...
WriteAttribute("href", Tuple.Create(" href=\"", 19230), Tuple.Create("\"", 19305)
            
            #line 323 "..\..\Views\Account\Index.cshtml"
                                    , Tuple.Create(Tuple.Create("", 19237), Tuple.Create<System.Object, System.Int32>(Url.Action("Delete", "Account", new { id = application.VacancyId })
