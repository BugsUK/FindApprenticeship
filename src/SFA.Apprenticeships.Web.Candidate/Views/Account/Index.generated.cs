...
WriteAttribute("href", Tuple.Create(" href=\"", 13138), Tuple.Create("\"", 13214)
            
            #line 227 "..\..\Views\Account\Index.cshtml"
                                                    , Tuple.Create(Tuple.Create("", 13145), Tuple.Create<System.Object, System.Int32>(Url.Action("Archive", "Account", new { id = application.VacancyId })
...
WriteAttribute("href", Tuple.Create(" href=\"", 18577), Tuple.Create("\"", 18652)
            
            #line 315 "..\..\Views\Account\Index.cshtml"
                                    , Tuple.Create(Tuple.Create("", 18584), Tuple.Create<System.Object, System.Int32>(Url.Action("Delete", "Account", new { id = application.VacancyId })
