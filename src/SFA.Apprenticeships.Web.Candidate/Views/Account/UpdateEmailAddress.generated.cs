...
namespace SFA.Apprenticeships.Web.Candidate.Views.Account
{
    ...
    ViewBag.Title = "Update Email Address - Find an apprenticeship";
...
"\n    yours.\r\n</p>\r\n");
 ...
 using (Html.BeginRouteForm(RouteNames.UpdateEmail, FormMethod.Post))
{
...
Write(Html.FormTextFor(m => m.EmailAddress, controlHtmlAttributes: new { autocomplete = "off" }));
