namespace SFA.Apprenticeships.Web.Candidate.Constants.Pages
{
    public class LoginPageMessages
    {
        ...
        public const string MobileVerificationRequiredText = "We've sent a verification code to your mobile number {0}.<br/>You won’t receive updates by text message until you <a href=\"{1}\">verify your number</a>. You can disable notifications in your <a href=\"/settings#accountSettings2\">settings</a>.";
