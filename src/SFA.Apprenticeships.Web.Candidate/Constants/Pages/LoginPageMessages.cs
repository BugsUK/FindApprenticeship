namespace SFA.Apprenticeships.Web.Candidate.Constants.Pages
{
    public class LoginPageMessages
    {
        ...
        public const string PendingUsernameVerificationRequiredText = "Your new email address has not yet been verified. <br/>You’ll be unable to sign in using your new email address until you <a href=\"{0}\">verify your email address</a>.";
