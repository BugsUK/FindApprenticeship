namespace SFA.Apprenticeships.Web.Candidate.Constants.ViewModels
{
    ...
    public static class WorkExperienceViewModelMessages
    {
        public static class DescriptionMessages
        {
            ...
            public const string TooLongErrorText = "Main duties must not be more than 200 characters";
        ...
        public static class EmployerMessages
        {
            ...
            public const string TooLongErrorText = "Employer name must not be more than 50 characters";
            public const string WhiteListRegularExpression = Whitelists.FreetextWhitelist.RegularExpression;
        ...
        public static class JobTitleMessages
        {
            ...
            public const string TooLongErrorText = "Job title must not be more than 50 characters";
            public const string WhiteListRegularExpression = Whitelists.FreetextWhitelist.RegularExpression;
