    ...
    public class CandidateUserRepository
    {
        ...
        private static ProjectionDefinition<Candidate> GetCandidateProjection()
        {
            return Builders<Candidate>.Projection
                ...
                .Include(c => c.ApplicationTemplate.EducationHistory.Institution)
                .Include(c => c.ApplicationTemplate.EducationHistory.FromYear)
                .Include(c => c.ApplicationTemplate.EducationHistory.ToYear)
                .Include(c => c.CommunicationPreferences.VerifiedMobile)
                .Include(c => c.CommunicationPreferences.MarketingPreferences.EnableEmail)
                .Include(c => c.CommunicationPreferences.MarketingPreferences.EnableText)
