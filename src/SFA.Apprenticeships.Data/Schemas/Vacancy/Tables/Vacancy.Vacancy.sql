CREATE TABLE [Vacancy].[Vacancy] (
    [VacancyGuid]                          UNIQUEIDENTIFIER             DEFAULT NEWSEQUENTIALID() NOT NULL,
    ...
    [ParentVacancyGuid]                    UNIQUEIDENTIFIER             NULL,
    ...
    PRIMARY KEY CLUSTERED ([VacancyGuid] ASC),
    ...
    CONSTRAINT [FK_Vacancy_ParentVacancyId] FOREIGN KEY ([ParentVacancyGuid]) REFERENCES [Vacancy].[Vacancy] ([VacancyGuid]),
