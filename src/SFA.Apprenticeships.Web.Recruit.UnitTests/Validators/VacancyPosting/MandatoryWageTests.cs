namespace SFA.Apprenticeships.Web.Recruit.UnitTests.Validators.VacancyPosting
{
    ...
    public class MandatoryWageTests
    {
        ...
        public void ApprenticeMinimumWage_PerHour_BeforeOctFirst(decimal wage, WageUnit wageUnit, decimal hoursPerWeek, bool expectValid)
        {
            ...
            {
                Wage = new WageViewModel() { Type = WageType.Custom, Classification = WageClassification.Custom, CustomType = CustomWageType.Fixed, Amount = wage, AmountLowerBound = null, AmountUpperBound = null, Text = null, Unit = wageUnit, HoursPerWeek = hoursPerWeek },
        ...
        public void ApprenticeMinimumWage_AfterOctFirst_DivideByZero()
        {
            ...
            var viewModel = new FurtherVacancyDetailsViewModel
            {
                Wage = new WageViewModel() { Type = WageType.Custom, Classification = WageClassification.Custom, CustomType = CustomWageType.Fixed, Amount = 123.45m, AmountLowerBound = null, AmountUpperBound = null, Text = null, Unit = WageUnit.Weekly, HoursPerWeek = 0 },
                VacancyDatesViewModel = new VacancyDatesViewModel
                {
                    PossibleStartDate = new DateViewModel(new DateTime(2016, 10, 1))
                }
