namespace SFA.Apprenticeships.Infrastructure.UnitTests.AzureServiceBus
{
    ...
    public class AzureServiceBusMessageBrokerTests
    {
        ...
        {
            var subscriber = new CandidateUpdateSubscriberMock(ServiceBusMessageStates.Complete);
            var subscribers = new List<IServiceBusSubscriber<CandidateUpdate>> { subscriber };
            ...
            var broker = new AzureServiceBusMessageBrokerBuilder<CandidateUpdate>().With(subscribers).With(clientFactory).Build();
            broker.Subscribe();
        ...
        {
            var subscriber = new CandidateUpdateSubscriberMock(ServiceBusMessageStates.Abandon);
            var subscribers = new List<IServiceBusSubscriber<CandidateUpdate>> { subscriber };
            var topicClient = new Mock<ITopicClient>();
            var subscriptionClient = new SubscriptionClientStub();
            var clientFactory = new Mock<IClientFactory>();
        ...
        {
            var subscriber = new CandidateUpdateSubscriberMock(ServiceBusMessageStates.DeadLetter);
            var subscribers = new List<IServiceBusSubscriber<CandidateUpdate>> { subscriber };
            var topicClient = new Mock<ITopicClient>();
            var subscriptionClient = new SubscriptionClientStub();
            var clientFactory = new Mock<IClientFactory>();
        ...
        {
            var subscriber = new CandidateUpdateSubscriberMock(ServiceBusMessageStates.Unknown);
            var subscribers = new List<IServiceBusSubscriber<CandidateUpdate>> { subscriber };
            var topicClient = new Mock<ITopicClient>();
            var subscriptionClient = new SubscriptionClientStub();
            var clientFactory = new Mock<IClientFactory>();
        ...
        {
            var subscriber = new CandidateUpdateSubscriberMock(ServiceBusMessageStates.Requeue);
            var subscribers = new List<IServiceBusSubscriber<CandidateUpdate>> { subscriber };
            var topicClient = new Mock<ITopicClient>();
