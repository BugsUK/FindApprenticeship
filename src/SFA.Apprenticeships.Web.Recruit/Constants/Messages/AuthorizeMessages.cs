namespace SFA.Apprenticeships.Web.Recruit.Constants.Messages
{
    public class AuthorizeMessages
    {
        ...
        public const string FirstUser = "As you're the first person to sign in from your organisation, please take a moment to review your training sites. Please email our <a href=\"mailto:nationalhelpdesk@findapprenticeship.service.gov.uk\">helpdesk</a> if any of your details need to be changed";
