namespace SFA.Apprenticeships.Application.UnitTests.Services.Provider
{
    ...
    [TestFixture]
    public class GetVacancyOwnerRelationshipsTests
    {
        ...
        private VacancyOwnerRelationship _providerSiteEmployerLink1;
        private VacancyOwnerRelationship _providerSiteEmployerLink2;
        private VacancyOwnerRelationship _providerSiteEmployerLink3;

        private List<Employer> _employersFromService;
        private List<VacancyOwnerRelationship> _fromRepository;

        private Mock<IEmployerService> _employerService;
        private Mock<IVacancyOwnerRelationshipReadRepository> _vacancyOwnerRelationshipReadRepository;
        ...
        public void ErnRepositorySearch()
        {
            ...
            var expectedResults = new List<VacancyOwnerRelationship> { _providerSiteEmployerLink2 };
            linksPage.Should().NotBeNull();
        ...
        public void NameRepositorySearch()
        {
            ...
            var expectedResults = new List<VacancyOwnerRelationship> { _providerSiteEmployerLink3 };
            linksPage.Should().NotBeNull();
            linksPage.Page.Count().Should().Be(expectedResults.Count);
            linksPage.Page.ShouldBeEquivalentTo(expectedResults);
            linksPage.ResultsCount.Should().Be(expectedResults.Count);
        ...
        public void NameAndPostCodeRepositorySearch()
        {
            ...
            var expectedResults = new List<VacancyOwnerRelationship> { _providerSiteEmployerLink1 };
            linksPage.Should().NotBeNull();
            linksPage.Page.Count().Should().Be(expectedResults.Count);
            linksPage.Page.ShouldBeEquivalentTo(expectedResults);
            linksPage.ResultsCount.Should().Be(expectedResults.Count);
