...
DECLARE @maxProviderId INT = (SELECT MAX(ProviderId) FROM dbo.Provider) + 1
DECLARE @maxProviderSiteId INT = (SELECT MAX(ProviderSiteId) FROM dbo.ProviderSite) + 1
DECLARE @maxProviderSiteRelationshipId INT = (SELECT MAX(ProviderSiteRelationshipId) FROM dbo.ProviderSiteRelationship) + 1
