CREATE PROCEDURE [dbo].[uspTrainingProviderSelectByUrnList]
...
EXEC (' SELECT               
 ...
 AND LAGT.LocalAuthorityGroupTypeID = 2             
 Left Outer Join County on County.CountyId = E.CountyId 
 WHERE                
 EdsUrn in (' + @urnList + ') AND    E.TrainingProviderStatusTypeId = 1   ')  
    
 -- EmployerTrainingProviderStatusId  
  
--SELECT               
--    E.TrainingProviderId              
-- ,E.FullName               
--    ,E.EdsUrn               
--    ,E.AddressLine1              
--    ,E.AddressLine2              
