CREATE PROCEDURE dbo.uspMessageGetSummaryByRecipientAndRecipientTypeForDivision
    @recipientType int,  
    @division int  
AS  
BEGIN  
                ...
                [Message] m  
                    ...
                    (  
                        ...
                        FROM  
                            ...
                            INNER JOIN dbo.vwManagingAreas ma ON ma.ManagingAreaId = m.Recipient
                        WHERE  
                            ma.DivisionId = @division AND  
