...
UPDATE [dbo].[ProviderSite]
   SET [FullName] = ISNULL(@fullName,[FullName])
    ...
    --  ,[UPIN] = ISNULL(@UPIN,[UPIN])
	  ...
	  ,[IsRecruitmentAgency] = 1
	  ,[ContactDetailsAsARecruitmentAgency] = @ContactDetailsAsARecruitmentAgency
