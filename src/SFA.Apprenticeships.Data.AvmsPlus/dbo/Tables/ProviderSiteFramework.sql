CREATE TABLE [dbo].[ProviderSiteFramework] (
    ...
    CONSTRAINT [PK_ProviderSiteFramework] PRIMARY KEY CLUSTERED ([ProviderSiteFrameworkID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY],
    ...
    CONSTRAINT [uq_idx_trainingProviderFramework] UNIQUE NONCLUSTERED ([ProviderSiteRelationshipID] ASC, [FrameworkId] ASC) WITH (FILLFACTOR = 90) ON [Index]
);
