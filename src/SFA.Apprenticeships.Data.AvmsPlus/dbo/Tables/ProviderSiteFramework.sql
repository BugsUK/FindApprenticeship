CREATE TABLE [dbo].[ProviderSiteFramework] (
    ...
    CONSTRAINT [FK_ProviderSiteFramework_ProviderSiteRelationship] FOREIGN KEY ([ProviderSiteRelationshipID]) REFERENCES [dbo].[ProviderSiteRelationship] ([ProviderSiteRelationshipID]) NOT FOR REPLICATION,
    CONSTRAINT [FK_TrainingProviderFramework_ApprenticeshipFramework] FOREIGN KEY ([FrameworkId]) REFERENCES [dbo].[ApprenticeshipFramework] ([ApprenticeshipFrameworkId]) NOT FOR REPLICATION,
