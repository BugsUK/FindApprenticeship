CREATE TABLE [dbo].[VacancyReferralComments] (
    ...
    CONSTRAINT [PK_VacancyReferralComments] PRIMARY KEY CLUSTERED ([VacancyReferralCommentsID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY],
    ...
    CONSTRAINT [uq_idx_vacancyReferralComments] UNIQUE NONCLUSTERED ([VacancyId] ASC, [FieldTypeId] ASC) WITH (FILLFACTOR = 90) ON [Index]
);
