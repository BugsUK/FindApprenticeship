...
WriteLiteral("        ");
   ...
   Write(Html.FormTextAreaFor(m => m.FirstQuestion, controlHtmlAttributes: new { @class = "form-control-3-4 beepboop form-textarea-medium", type = "text" }));
...
WriteLiteral("        ");
   ...
   Write(Html.FormTextAreaFor(m => m.SecondQuestion, controlHtmlAttributes: new { @class = "form-control-3-4 beepboop form-textarea-medium", type = "text" }));
