...
WriteAttribute("src", Tuple.Create(" src=\"", 10314), Tuple.Create("\"", 10369)
, Tuple.Create(Tuple.Create("", 10320), Tuple.Create<System.Object, System.Int32>(Href("~/Content/_assets/js/vendor/nanospell/autoload.js")
, 10320), false)
);
