...
namespace SFA.Apprenticeships.Web.Raa.Common.Constants.ViewModels
{
    public class EmployerSearchViewModelMessages
    {
        ...
        public const string NameOrLocationSearchRequiredErrorText = "Enter an employer name or a town or postcode to search";
        ...
        {
            public const string LabelText = "Employer Id";
        }
