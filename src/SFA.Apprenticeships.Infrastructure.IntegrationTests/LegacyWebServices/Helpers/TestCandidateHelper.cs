namespace SFA.Apprenticeships.Infrastructure.IntegrationTests.LegacyWebServices.Helpers
{
    using System;
        ...
        public static Candidate CreateFakeCandidate()
        {
            var candidate = new Candidate
            {
                ...
                RegistrationDetails = new RegistrationDetails
                {
                    FirstName = "NAS",
                    LastName = "Exemplar",
                    EmailAddress = string.Format("nas.exemplar+{0}@gmail.com", DateTime.UtcNow.Ticks),
