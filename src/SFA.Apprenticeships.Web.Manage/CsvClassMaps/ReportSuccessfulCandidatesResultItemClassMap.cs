namespace SFA.Apprenticeships.Web.Manage.CsvClassMaps
{
    ...
    public sealed class ReportSuccessfulCandidatesWithIdsResultItemClassMap : CsvClassMap<ReportSuccessfulCandidatesResultItem>
    {
        public ReportSuccessfulCandidatesWithIdsResultItemClassMap()
        {
