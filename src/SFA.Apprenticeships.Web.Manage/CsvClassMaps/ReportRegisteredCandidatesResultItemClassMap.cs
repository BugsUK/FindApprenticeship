namespace SFA.Apprenticeships.Web.Manage.CsvClassMaps
{
    ...
    public sealed class ReportRegisteredCandidatesResultItemClassMap : CsvClassMap<ReportRegisteredCandidatesResultItem>
    {
    ...
    public sealed class ReportRegisteredCandidatesWithIdsResultItemClassMap : CsvClassMap<ReportRegisteredCandidatesResultItem>
    {
        public ReportRegisteredCandidatesWithIdsResultItemClassMap()
        {
