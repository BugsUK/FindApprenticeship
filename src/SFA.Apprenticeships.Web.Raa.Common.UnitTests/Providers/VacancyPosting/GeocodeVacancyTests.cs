    ...
    public class GeoCodeVacancyTests : TestBase
    {
        ...
        public void SetUp()
        {
            ...
            MockVacancyPostingService.Setup(
                mock =>
                    mock.GetVacancyByReferenceNumber(
                        _validNewVacancyViewModelWithReferenceNumber.VacancyReferenceNumber.Value))
                        ...
                        Standards =
                            new List<Standard>
                            {
                                ...
                                new Standard
                                {
                                    Id = 6,
                                    ApprenticeshipSectorId = 1,
                                    ApprenticeshipLevel = ApprenticeshipLevel.Masters
                                }
                            }
                    }
                });
        ...
        public void ShouldAssignGeoCodeToVacancyWithSingleAddressDifferentToEmployer()
        {
            ...
            MockVacancyPostingService.Verify(
                m => m.CreateApprenticeshipVacancy(It.Is<Vacancy>(av => av.Address.GeoPoint == geopoint)));
            MockVacancyPostingService.Verify(m => m.CreateApprenticeshipVacancy(It.IsAny<Vacancy>()), Times.Once);
        }
