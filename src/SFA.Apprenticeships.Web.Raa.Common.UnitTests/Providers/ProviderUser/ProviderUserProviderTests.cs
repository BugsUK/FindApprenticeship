namespace SFA.Apprenticeships.Web.Raa.Common.UnitTests.Providers.ProviderUser
{
    ...
    public class ProviderUserProviderTests
    {
        ...
        public void ShouldUpdateUserProviderWhenEmailVerificationCodeIsValid()
        {
            ...
            providerUser.Status.Should().Be(ProviderUserStatuses.EmailVerified);
        ...
        public void ShouldSaveNewProviderUser()
        {
            ...
            newProviderUser.Status.Should().Be(ProviderUserStatuses.Registered);

            // Assert: view model
            savedViewModel.Should().NotBeNull();

            savedViewModel.Fullname.Should().Be(originalViewModel.Fullname);
            // TODO: SQL: AG: Email vs EmailAddress.
            ...
            // TODO: SQL: AG: DefaultProviderSiteErn vs PreferredSiteErn.
            savedViewModel.DefaultProviderSiteErn.Should().Be(originalViewModel.DefaultProviderSiteErn);
