namespace SFA.Apprenticeships.Web.Candidate.UnitTests.Mediators.Login
{
    ...
    public class UnlockTests
    {
        ...
        [TestCase(AccountUnlockState.AccountEmailAddressOrUnlockCodeInvalid,
            LoginMediatorCodes.Unlock.AccountEmailAddressOrUnlockCodeInvalid,
            AccountUnlockPageMessages.WrongEmailAddressOrAccountUnlockCodeErrorText, UserMessageLevel.Error)]
        [TestCase(AccountUnlockState.AccountUnlockCodeExpired, LoginMediatorCodes.Unlock.AccountUnlockCodeExpired,
            AccountUnlockPageMessages.AccountUnlockCodeExpired, UserMessageLevel.Warning)]
        [TestCase(AccountUnlockState.Error, LoginMediatorCodes.Unlock.AccountUnlockFailed,
            AccountUnlockPageMessages.AccountUnlockFailed, UserMessageLevel.Warning)]
