    ...
    public class ResendTests
    {
        ...
        public void AccountEmailAddressOrUnlockCodeInvalid()
        {
            var viewModel = new AccountUnlockViewModel
            {
                ...
                ViewModelMessage = "Unknown username=ab@cde.com",
            ...
            candidateServiceProvider.Setup(x => x.RequestAccountUnlockCode(It.IsAny<AccountUnlockViewModel>()))
                .Returns(viewModel);
            ...
            response.AssertMessage(LoginMediatorCodes.Resend.ResentSuccessfully,
                AccountUnlockPageMessages.AccountUnlockCodeMayHaveBeenResent, UserMessageLevel.Success, true);
        }
        ...
        public void Error()
        {
            ...
            response.AssertMessage(LoginMediatorCodes.Resend.ResendFailed,
                AccountUnlockPageMessages.AccountUnlockResendCodeFailed, UserMessageLevel.Warning, true);
        }
        ...
        public void UserInIncorrectState()
        {
            ...
            {
                EmailAddress = "ab@cde.com",
                ViewModelMessage = "Send unlock code",
