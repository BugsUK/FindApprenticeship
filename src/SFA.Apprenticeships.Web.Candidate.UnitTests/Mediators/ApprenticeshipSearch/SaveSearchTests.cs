    ...
    public class SaveSearchTests
    {
        ...
        public void HasError()
        {
            ...
            candidateServiceProvider.Setup(
                ...
                .Returns(
                    new ApprenticeshipSearchViewModelBuilder().WithMessage(
                        VacancySearchResultsPageMessages.SaveSearchFailed).Build());
            ...
            response.AssertMessage(ApprenticeshipSearchMediatorCodes.SaveSearch.HasError,
                VacancySearchResultsPageMessages.SaveSearchFailed, UserMessageLevel.Error, true);
