namespace SFA.Apprenticeships.Web.Candidate.UnitTests.Mediators.ApprenticeshipApplication
{
    ...
    public class SaveTests : TestsBase
    {
        ...
        public void AlreadySubmitted()
        {
            ...
            response.AssertMessage(ApprenticeshipApplicationMediatorCodes.Save.IncorrectState,
        ...
        public void Error()
        {
            ...
            ApprenticeshipApplicationProvider.Setup(p => p.GetApplicationViewModel(It.IsAny<Guid>(), ValidVacancyId))
                .Returns(new ApprenticeshipApplicationViewModel("Has Error"));

            var response = Mediator.Save(Guid.NewGuid(), ValidVacancyId, viewModel);

            response.AssertMessage(ApprenticeshipApplicationMediatorCodes.Save.Error, ApplicationPageMessages.SaveFailed,
        ...
        public void OfflineVacancy()
        {
            ...
            ApprenticeshipApplicationProvider.Setup(p => p.GetApplicationViewModel(It.IsAny<Guid>(), ValidVacancyId))
                .Returns(new ApprenticeshipApplicationViewModel
                {
                    ...
                    VacancyDetail = new ApprenticeshipVacancyDetailViewModel {ApplyViaEmployerWebsite = true}
                });
            ApprenticeshipApplicationProvider.Setup(
                p =>
                    p.PatchApplicationViewModel(It.IsAny<Guid>(), It.IsAny<ApprenticeshipApplicationViewModel>(),
        ...
        public void VacancyNotFound()
        {
            ...
            ApprenticeshipApplicationProvider.Setup(p => p.GetApplicationViewModel(It.IsAny<Guid>(), ValidVacancyId))
                .Returns(new ApprenticeshipApplicationViewModel {Status = ApplicationStatuses.ExpiredOrWithdrawn});
